    ...
    >
      ...
      <span slot="action" slot-scope="text, record">
          <template>
            ...
            <a @click="marketStudentDelete(record)">删除</a>
          </template>
        </span>
    </s-table>


    <CreateMarketStudentForm
      ref="createMarketStudentForm"
      :visible="visible"
...
<script>
  ...
  import CreateMarketStudentForm from "./components/CreateMarketStudentForm";
